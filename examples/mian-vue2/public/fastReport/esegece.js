...
function sgcws() {
	...
	var c = new fxEvent("onsgcmessage");
	var h = new fxEvent("onsgcevent");
	var d = new fxEvent("onsgcsubscribe");
	var f = new fxEvent("onsgcunsubscribe");
	var j = new fxEvent("onsgcrpcresult");
	var b = new fxEvent("onsgcrpcerror");
	var i = new fxEvent("onsgcacknowledgment");
	var a = new fxEvent("onsgcsession");
								...
								if (obj.result.method == "sgc@session") {
									...
									if (obj.result.method == "sgc@message") {
										...
										if (obj.result.method == "sgc@acknowledgment") {
											...
											if(obj.result['IncomingTel.RD']){
												j.fire({name: 'onsgcrpcresult', result: obj.result['IncomingTel.RD']})
											}else{
												j.fire({
														name : "onsgcrpcresult",
														result : obj.result,
