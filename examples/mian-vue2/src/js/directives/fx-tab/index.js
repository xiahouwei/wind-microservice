...
const isFxDetialsQueueTools = function (vnode) {
	return vnode.componentInstance.$options._componentTag === 'fx-details-queue-tools'
}
const isFxDetialsTable = function (vnode) {
	return vnode.componentInstance.$options._componentTag === 'fx-details-table'
}
const bindCascaderPopperTabEvent = function (vnode, fxTabHandler) {
	...
	const inputEl = vnode.componentInstance.$refs.cascader.$refs.input.$el
	popperEl.fxTabHandler = fxTabHandler
	inputEl.fxTabHandler = fxTabHandler
	popperEl.addEventListener('keydown', fxTabHandler)
	inputEl.addEventListener('keydown', fxTabHandler)
}
