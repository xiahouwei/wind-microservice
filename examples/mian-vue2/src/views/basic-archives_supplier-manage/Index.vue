<template>
	<w-app-container>
		<fx-page-header title="供货商"></fx-page-header>
		<w-app-container direction="row" class="fx-page-first-container">
			<treeContainer
				ref="treeContainer"
				:canAdd="detailsAuthGetter('basic-archives_supplier-manage.add-supplierCategory')"
				:canEdit="detailsAuthGetter('basic-archives_supplier-manage.edit-supplierCategory')"
				:canDelete="detailsAuthGetter('basic-archives_supplier-manage.delete-supplierCategory')"
