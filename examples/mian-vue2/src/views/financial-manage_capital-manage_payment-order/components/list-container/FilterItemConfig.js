	...
	bankAccount (h) {
		...
		return (
			<el-form-item label="付款银行账号">
				<w-input vModel={this.filter.bankAccount} placeholder="请输入" class="form-input"/>
			</el-form-item>
		)
	},
	memo (h) {
	...
	bdmemo (h) {
		...
		return (
			<el-form-item label="明细备注">
				<w-input vModel={this.filter.bdmemo} placeholder="请输入" class="form-input-large"/>
			</el-form-item>
		)
	}
}
