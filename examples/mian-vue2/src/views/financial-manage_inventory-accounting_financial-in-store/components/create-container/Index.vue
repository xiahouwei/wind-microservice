<template>
	...
	>
		...
		<template slot="footer-right">
			<fx-button
				ref="cancelBtn"
				v-fx-tab:loop.financial-manage_financial-in-store_details.cancelBtn
				@click="onCancelClick"
			>取消</fx-button>
			<fx-button
				ref="saveBtn"
				...
				v-fx-tab:loop.financial-manage_financial-in-store_details.saveBtn
				@click="onSaveClick"
			>保存</fx-button>
			<fx-button
				ref="submitBtn"
				...
				v-fx-tab:loop.financial-manage_financial-in-store_details.submitBtn
			...
			<fx-button
				...
				v-fx-tab:loop.financial-manage_financial-in-store_details.returnBtn
			...
			<fx-button
				...
				v-fx-tab:loop.financial-manage_financial-in-store_details.checkBtn
			...
			<fx-button
				...
				v-fx-tab:loop.financial-manage_financial-in-store_details.uncheckBtn
			...
			<fx-button
				...
				v-fx-tab:loop.financial-manage_financial-in-store_details.recheckBtn
			...
			<fx-button
				...
				v-fx-tab:loop.financial-manage_financial-in-store_details.unrecheckBtn
			...
			>
				<fx-button
					...
					v-fx-tab:loop.financial-manage_financial-in-store_details.pushDownBtn
				>下推</fx-button>
...
export default {
	...
	created () {
		this.$fxTabkey.init('financial-manage_financial-in-store_details', this)
	},
	methods: {
		...
		onDeleteHandler () {
			const logger = this.$fxLogger.createInfo('financial-manage.inventory-accounting.financial-in-store.delete', { orderData: this.organDetails })
		...
		onBuyerSubmitHandler () {
			const logger = this.$fxLogger.createInfo('financial-manage.inventory-accounting.financial-in-store.submit', { orderData: this.organDetails })
		...
		onBuyerReturnClick () {
			return this.$fxConfirm('是否确定退回？').then(() => {
				const logger = this.$fxLogger.createInfo('financial-manage.inventory-accounting.financial-in-store.return', { orderData: this.organDetails })
		...
		onBuyerCheckHandler () {
			const logger = this.$fxLogger.createInfo('financial-manage.inventory-accounting.financial-in-store.check', { orderData: this.organDetails })
		...
		onBuyerUncheckClick () {
			return this.$fxConfirm('是否确定反审？').then(() => {
				const logger = this.$fxLogger.createInfo('financial-manage.inventory-accounting.financial-in-store.uncheck', { orderData: this.organDetails })
		...
		onBuyerRecheckClick () {
			return this.$fxConfirm('是否确定复审？').then(() => {
				const logger = this.$fxLogger.createInfo('financial-manage.inventory-accounting.financial-in-store.recheck', { orderData: this.organDetails })
		...
		onBuyerUnrecheckClick () {
			return this.$fxConfirm('是否确定取消复审？').then(() => {
				const logger = this.$fxLogger.createInfo('financial-manage.inventory-accounting.financial-in-store.unrecheck', { orderData: this.organDetails })
		...
		onEstimationPayableClick () {
			return this.$fxConfirm('是否确定下推？').then(() => {
				const logger = this.$fxLogger.createInfo('financial-manage.inventory-accounting.financial-in-store.pushDownEstimationPayable', { orderData: this.organDetails })
		...
		onStandardPayableClick () {
			return this.$fxConfirm('是否确定下推？').then(() => {
				const logger = this.$fxLogger.createInfo('financial-manage.inventory-accounting.financial-in-store.pushDownStandardPayable', { orderData: this.organDetails })
