<template>
	<w-dialog v-model="dialogVisible" title="异常警告" width="1200px" heightFullscreen @close="clear">
		<div class="create-organ">
			<fx-mistake-check-step :activeStep="2" type="InStore"></fx-mistake-check-step>
			<div class="mistake-check-warning fx-warn-font">注：以下品项为当前入库仓库未关联品项，请手动全部删除！</div>
			<fx-details-table
				ref="detailsTable"
...
export default {
	...
	methods: {
		...
		getRel () {
			return this.$fxApi('inStore.Rel', this.organDetails.id).then(res => {
