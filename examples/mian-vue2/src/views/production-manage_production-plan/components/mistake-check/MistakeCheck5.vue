<template>
	<w-dialog v-model="dialogVisible" title="异常警告" width="1200px" heightFullscreen @close="clear">
		<div class="create-organ">
			<fx-mistake-check-step :activeStep="5" type="InStore"></fx-mistake-check-step>
...
export default {
	...
	methods: {
		...
		onSyncPriceHandler (details) {
			...
			const logger = this.$fxLogger.createInfo('production-manage.production-plan.syncPrice', { itemNames: this.getItemNames(details), orderData: this.organDetails })
