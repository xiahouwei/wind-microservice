	...
	inAssignStatus (h) {
		...
		return (
			<el-form-item label="入库状态">
				<w-select-mulity
					vModel={this.inAssignStatus}
					optionlist={this.inAssignStateList}
					class="form-input"
					showEmpty={false}
					optionProp={{ name: 'label' }}
				></w-select-mulity>
	...
	outAssignStatus (h) {
		...
		return (
			<el-form-item label="出库状态">
				<w-select-mulity
					vModel={this.outAssignStatus}
					optionlist={this.outAssignStateList}
					class="form-input"
					showEmpty={false}
					optionProp={{ name: 'label' }}
				></w-select-mulity>
