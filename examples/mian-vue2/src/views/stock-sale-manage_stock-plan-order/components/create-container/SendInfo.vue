<template>
	<w-collapse v-model="collapseVisible" disabled :showArrow="false" title="送货信息">
		<el-form ref="form" :model="organDetails" size="mini" label-width="100px" inline>
			...
			<el-form-item label="送货地址：">
				<w-input
					...
					v-fx-tab:loop.stock-sale-manage_stock-plan-order_details.sendInfo
					:maxlength="$fxCommon.getFxInputMaxLength('deliveryAddr')"
					:regType="$fxCommon.getFxInputReg('deliveryAddr')"
					:disabled="disabled"
					class="form-item-input-address"
				></w-input>
			</el-form-item>
		</el-form>
	</w-collapse>
