...
export default {
	...
	data () {
		return {
			...
			columnProp: {
				food_bom: ['name', 'bomName', 'itemName', 'itemUnit', 'spec', 'materialDosage', 'materialRate', 'rawMaterialDosage', 'ingredientsType', 'beginDate', 'endDate'],
				compose_bom: ['name', 'bomName', 'itemName', 'itemUnit', 'spec', 'materialDosage', 'materialRate', 'rawMaterialDosage', 'beginDate', 'endDate'],
				split_bom: ['name', 'bomName', 'itemName', 'itemUnit', 'spec', 'outputYield', 'beginDate', 'endDate']
			},
