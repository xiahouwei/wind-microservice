<template>
	<el-dialog
		...
		<div slot="title" class="wind-dialog__title fx-block-title">
			...
			<div v-if="$slots.parentBill" class='parentBill__container'>
...
export default {
	...
	computed: {
		...
		classes () {
			const defaultClass = 'wind-custom-dialog'
			if (this.heightFullscreen) {
				return `${defaultClass} wind-dialog-is-heightFullscreen`
			}
			return defaultClass
		},
		moreBtnVisible () {
