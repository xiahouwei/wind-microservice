...
export default {
	...
	methods: {
		...
		emitInput (value) {
			const inputValue = typeof (this.value) === 'string' ? value : this.$fxUtils.toNumber(value)
			this.$emit('input', inputValue)
		},
		emitChange (value) {
			const changedvalue = typeof (this.value) === 'string' ? value : this.$fxUtils.toNumber(value)
